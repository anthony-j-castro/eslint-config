...
5. After the "Create release" workflow completes and the new version is created, update the version number in the [Installation](#installation) section of this README.
